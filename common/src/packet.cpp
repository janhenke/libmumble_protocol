...
google::protobuf::Message const &MumbleVersionPacket::message() const { return m_version; }
...
google::protobuf::Message const &MumbleAuthenticatePacket::message() const { return m_authenticate; }

/*
 * Mumble ping packet (ID 3)
 */

MumblePingPacket::MumblePingPacket(std::uint64_t timestamp) { m_ping.set_timestamp(timestamp); }
...
const google::protobuf::Message &MumblePingPacket::message() const { return m_ping; }
...
const google::protobuf::Message &MumbleCryptographySetupPacket::message() const { return m_cryptSetup; }
